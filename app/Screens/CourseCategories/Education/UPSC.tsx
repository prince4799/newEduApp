    ...
    return (
        <SafeAreaView
            ...
            <ScrollView
                ...
                >
                    <Text style={styles.flatlisttitle}>History Classes</Text>
                ...
                source={IMAGES.gradientbg}
                    style={styles.flatlistContainer}
                >
                    <Text style={styles.flatlisttitle}>GS Classes</Text>
                ...
                source={IMAGES.gradientbg}
                    style={styles.flatlistContainer}
                >
                    <Text style={styles.flatlisttitle}>Geography classes</Text>
